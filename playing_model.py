...
class PpoModel(nn.Module):
    def __init__(self):
        ...
        self.actor_out_layer = nn.Linear(128, 4)
    ...
    def get_action(self, state):
        ...
        action_dist = Categorical(logits=action)

        action_chosen = action_dist.sample()
        return action_chosen.item(), value, action_dist.log_prob(action_chosen), action_dist.entropy()
